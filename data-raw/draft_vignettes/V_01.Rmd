...
```{r}
procureSlot(y,
            "predictors_lup") # Define print method
```
...
procureSlot(y,
    ...
    ready4show::print_table(output_type_1L_chr = "HTML", # Define exhibit method
...
exhibit(x,
        mkdn_tbl_refs_chr = "tab:mdl_cmprsn",
...
```{r}
# MAKE renew MTHD
#x@c_SpecificResults@a_SpecificShareable@shareable_outp_ls$mdl_smry_ls$prefd_mdl_types_chr <- c("OLS_NTF", "BET_CLL")
```
...
```{r}
# x@c_SpecificResults@a_SpecificShareable@shareable_outp_ls$mdl_smry_ls$predr_cmprsn_tb %>%
...
```{r}
# x@c_SpecificResults@a_SpecificShareable@shareable_outp_ls$mdl_smry_ls$prefd_covars_chr <- c("COVARIATE WE WANT TO USE", "ANOTHER COVARIATE")
```
