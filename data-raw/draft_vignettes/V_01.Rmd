...
```{r}
y <- renewSlot(y,
               "candidate_mdls_lup", # Make slot a dyad child
...
exhibit(x,
        # mkdn_tbl_refs_chr = "tab:mdl_cmprsn", # Make default
        # output_type_1L_chr = "HTML", # Make default
...
```{r}
x <- renew_SpecificProject(x,
                          new_val_xx = c("OLS_NTF", "BET_CLL"),
                          type_1L_chr = "results",
                          what_1L_chr = "prefd_mdls")
```
...
exhibit(x,
        mkdn_tbl_refs_chr = "tab:predr_cmprsn", # Make default
        output_type_1L_chr = "HTML", # Make default
