...
```{r warning = F}
path_to_write_to_1L_chr <- tempdir()#"Output" # Move to new d_Ready4usePointer slot of x
```
...
investigate_SpecificInitiator <- function(x,
    ...
    dir.create(path_to_write_to_1L_chr)#      ready4::write_new_dirs(path_to_write_to_1L_chr)
...
ds_smry_ls <- make_ds_smry_ls(candidate_predrs_chr = x@b_SpecificParameters@candidate_predrs_chr,
                              ...
                              round_var_nm_1L_chr = round_var_nm_1L_chr, # Series
...
```{r}
x <- investigate_SpecificInitiator(x,
