...
``` 
```{r}
X@c_SpecificResults@a_SpecificShareable@shareable_outp_ls$session_data_ls <- sessionInfo()
```
...
mdl_nm_1L_chr <- ranked_mdl_nms_chr[1]
...
tfmn_1L_chr <- ready4::get_from_lup_obj(mdl_types_lup,
                                        ...
                                        evaluate_1L_lgl = F)
plot_fn_and_args_ls <- make_plot_fn_and_args_ls(brms_mdl = K10_1_OLS_CLL,
