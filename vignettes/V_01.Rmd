...
X <- renewSlot(X, "b_SpecificParameters@predictors_lup", 
               ...
               increment_dbl = 1,  class_fn_chr = c("youthvars::youthvars_k10_aus","as.integer"),
               mdl_scaling_dbl = 0.01, covariate_lgl = F)
```
...
X <- renewSlot(X,"b_SpecificParameters@descv_var_nms_chr",
               c("d_age","Gender","d_relation_s", "d_sexual_ori_s", "Region", "d_studying_working")) 
```
