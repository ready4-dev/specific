...
```{r}
predictors_lup <- TTU::TTU_predictors_lup(TTU::make_pt_TTU_predictors_lup(short_name_chr = c("K10_int","Psych_well_int"),
...
ds_smry_ls <- make_ds_smry_ls(candidate_predrs_chr = predictors_lup$short_name_chr,
                              ...
                              dictionary_tb = dictionary_tb, #Dyad
                              id_var_nm_1L_chr = "uid", # Profile
                              round_var_nm_1L_chr = "Timepoint", # Series
...
```{r}
mdl_smry_ls <- mdl_types_lup %>% # New specific cls
  make_mdl_smry_ls()
```
