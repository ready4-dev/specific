...
input_params_ls$scndry_anlys_params_ls <- make_scndry_anlys_params(candidate_predrs_chr = c("d_age"),
...
input_params_ls$params_ls$control_ls <- X@b_SpecificParameters@control_ls
input_params_ls$params_ls$prior_ls <- X@b_SpecificParameters@prior_ls
input_params_ls$params_ls$iters_1L_int <- X@b_SpecificParameters@iters_1L_int

# %>%
#   make_scndry_anlys_params(candidate_predrs_chr = c("d_age"),
#                                                    prefd_covars_chr = NA_character_)

#X@a_YouthvarsProfile@a_Ready4useDyad@ds_tb$dage
```
