---
title: "Use SpecificProject and SpecificParameters To Undertake An Exploratory Analysis"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Use SpecificProject and SpecificParameters To Undertake An Exploratory Analysis}
...
The `investigate` method will write each model to be tested to a new sub-directory of our output directory. Also written to that sub-directory are a number of plots for each model, that can be inspected using the `depict` method.
