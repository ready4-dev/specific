...
#                                   cohort_descv_var_nms_chr = c("d_age","Gender","d_relation_s",
...
ds_descvs_ls <- manufacture_SpecificModels(x,
...
x@a_YouthvarsProfile@a_Ready4useDyad@ds_tb <- x@a_YouthvarsProfile@a_Ready4useDyad@ds_tb %>%
  transform_mdl_vars_with_clss(predictors_lup = x@b_SpecificParameters@predictors_lup,
                               ...
                               prototype_lup = prototype_lup, # Supplied as arg?
                               class_fn_1L_chr = class_fn_1L_chr # Supplied as arg?
                               )
return(x)
...
object_xx <- make_ds_descvs_ls(candidate_predrs_chr =  x@b_SpecificParameters@candidate_predrs_chr,
                                  ...
                                  cohort_descv_var_nms_chr = x@b_SpecificParameters@cohort_descv_var_nms_chr, 
...
```{r}
Y <- ratify_SpecificModels(Y)
Y <- author_SpecificModels(Y,
                           what_1L_chr = "workspace")
```
